...
if __name__ == '__main__':
 ...
 #doc1="Perennial party girl Tara Reid checked herself into Promises Treatment Center, her rep told People."
 #doc2= "A friend of the actress told People she went to Promises on Tuesday and that her friends and family supported her decision."
 doc1="The actress who is more into rehab" 
 doc2 = "it"
 print "Using Doc1: %s\n\nUsing Doc2: %s\n" % ( doc1, doc2 )
